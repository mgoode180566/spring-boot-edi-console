...
<div class="container">
    ...
    <table class="table prod-table-cont">
        <thead>
        <tr>
            <th width="140px">Callout</th>
            <th width="100px">CValue2</th>
            <th width="140px">CValue3</th>
            <th width="150px">Product</th>
            <th width="100px">Style</th>
            <th width="100px">UValue3</th>
        ...
        <c:forEach var="value" items="${list}" varStatus="status">
            <tr>
                <td width="140px">${value.CValue1}</td>
                <td width="100px">${value.CValue2}</td>
                <td width="100px">${value.CValue3}</td>
                <td width="150px">${value.UValue1}</td>
                <td width="100px">${value.UValue2}</td>
                <td width="100px">${value.UValue3}</td>
                <td width="200px">${value.createdDate}</td>
                <td width="100px"><a href="deleteproduct?programid=${id}&id=${value.id}" class="btn btn-danger">Delete</a></td>
            </tr>
        </c:forEach>
    </table>
</div>
